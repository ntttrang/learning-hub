...
/**
 * Leitner-style spaced repetition. (Ported from learn-dp-800/src/lib/srs.ts —
 * semantics unchanged; only the type import moved to the SDK.)
 *
 ...
 * always tracked so they resurface; correct ones only update if already
 * tracked (only-after-first-miss).
 */
