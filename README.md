...
| [`learn-gh-600/`](learn-gh-600/) | Go / Docker / AWS certification | Static HTML | `make run` → http://localhost:8080 |
...
The three apps are being merged into one Vite + React 19 SPA where every
